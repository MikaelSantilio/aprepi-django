...
urlpatterns = [
    ...
    path('cartoes/atualizar/<int:pk>', views.CreditCardUpdateView.as_view(), name='update-cc'),
    path('cartoes/apagar/<int:pk>', views.CreditCardDeleteView.as_view(), name='delete-cc')
]
